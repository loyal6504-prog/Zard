...
EMOJI_PACKS = [
    {   # 0: Red
        ...
        "kol":     5805284123207541993,
        "mae":     5805383319772209301,
        "bot":     5805247255208272192,
        "chain": {
            "SOL":  5805263915386413121,
            "ETH":  5805519783768105903,
            "BNB":  5805551429087141454,
            "BSC":  5805551429087141454,
            "BASE": 5805512538158276517,
            "RH":   5805673530712400217,  # Robinhood red
            "TON":  5805445132941533856,  # TON red
        },
    },
    {   # 1: Blue
        "name": "blue",
        "crystal": 5909212560720142417,
        "kol":     5803081316085801545,
        "mae":     5801054392169799401,
        "bot":     5802911415769506568,
        "chain": {
    ...
    {   # 3: Purple
        ...
        "kol":     5805305430540297057,
        "mae":     5805269198196188467,
        "bot":     5805630954701595827,
        "chain": {
    ...
    {   # 5: Orange
        ...
        "kol":     5803030674126413855,
        "mae":     5805296913620148696,
        "bot":     5803228178197520439,
        "chain": {
    ...
    {   # 4: Green
        ...
        "kol":     5802988952814099800,
        "mae":     5803375340956949524,
        "bot":     5800742203881955444,
        "chain": {
...
DROPPED_CALL_EMOJI = 5807538512886505504  # SOL chain emoji — default fallback when chain unknown

# Chain-specific emojis for the two header 🔮 in dropped-call posts
DROPPED_CHAIN_EMOJIS = {
    "SOL":  5807538512886505504,
    "ETH":  5810067535659277389,
    "BNB":  5807416286707196288,
    "BSC":  5807416286707196288,
    "BASE": 5807792792130298368,
    "RH":   5809746628587822606,
    "TON":  5807613125058371280,  # TON drop call emoji
}

# Specific emoji IDs for KOL / MAE / BOT links in dropped-call posts
DROPPED_KOL_EMOJI = 5807550659054018382
