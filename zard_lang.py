...
_OH_PANELS_RAW = {
    ...
    "lang": ("Chn, Vtmm",
        "🌏 <b>PER-KOL LANGUAGE TEMPLATES</b>\n\n"
        "Kisi KOL ko Chinese ya Vietnamese tag do, phir uska apna template "
        "(uski language mein) set karo — sirf usi KOL ki posts is template se jaengi, "
        "baaki sab normal English rahenge.\n\n"
        "🏷 <b>Tag lagao</b>\n"
        "<code>/setkollang CHANNEL chinese|vietnamese|english</code>\n"
        "/listkollang — sab tagged KOLs dekho\n\n"
        "✏️ <b>X-alert templates (2-99X, 100-499X, wagera)</b>\n"
        "<code>/setkoltemplate CHANNEL LOW HIGH</code> — phir agla message template text\n"
        "/listkoltemplates CHANNEL · /delkoltemplate CHANNEL LOW HIGH\n\n"
        "📣 <b>Dropped-Call (pehli baar call) template</b>\n"
        "<code>/setkoldroppedtemplate CHANNEL</code> — phir agla message template text\n"
        "/showkoldroppedtemplate CHANNEL · /clearkoldroppedtemplate CHANNEL\n\n"
        "ℹ️ Jis KOL ka tag/template set nahi kiya, uski posts English mein hi jati rahengi.",
        [("🏷 Set KOL lang", "oh:tip:setkollang"),
         ("📋 List KOL langs", "oh:tip:listkollang"),
         ("✏️ Set X template", "oh:tip:setkoltemplate"),
         ("📋 List X templates", "oh:tip:listkoltemplates"),
         ("📣 Set dropped tmpl", "oh:tip:setkoldroppedtemplate"),
         ("👀 Show dropped tmpl", "oh:tip:showkoldroppedtemplate")]),
