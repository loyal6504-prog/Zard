...
X_TIER_PARAGRAPHS = [
    ...
    (100, 499,
        "@{channel} delivered {x}X. ${symbol} was called at a {entry} MC. "
    ...
    (500, 999,
        ...
        "climbing from {entry} MC to {current}. "
        "Another milestone secured. Based KOL of Wizard Scan."
    ),
    (1000, 1999,
        "@{channel} nailed {x}X. ${symbol} was called at a {entry} MC and has "
        "now climbed to {current}. "
        "A truly elite performance with exceptional returns."
    ),
    (2000, 2999,
        "@{channel} crushed {x}X. ${symbol} was called at a {entry} MC and has "
        "now reached {current}. "
        "An extraordinary run that stands among the rarest performances."
    ),
    (3000, 4999,
        "@{channel} smashed {x}X. From {entry} MC to {current}, ${symbol} "
    ...
    (5000, 9999,
        ...
        "climbed from {entry} MC to {current}, once again delivering "
