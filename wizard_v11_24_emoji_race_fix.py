...
def build_alert(channel, msg_id, x_val, chain, entry_fmt, current_fmt, ca, symbol, badge=None, x_style=False):
    ...
    if badge:
        if badge["type"] == "leaderboard":
            badge_html = f' <a href="https://t.me/WizardScan/136">Leaderboard KOL</a> - Rank # 🔮'
        else:
            badge_html = f' <a href="https://t.me/WizardScan/137">Champion KOL</a> - Rank # 🔮'
    ...
    if channel.lower() in ("testkol", "test_kol", "demokol"):
        ...
        for r in DEMO_RESULTS:
            ...
            lines.append(
                ...
                f"     View Post  |  {entry_safe} {PE_ARROW} {ms_mc_safe}"
            )
        XRAY_FOOTER = (
