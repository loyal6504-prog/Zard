...
MAX_MC_LIQ_RATIO   = float(os.environ.get("MAX_MC_LIQ_RATIO",   "400"))    # mc / liquidity
MAX_PLAUSIBLE_MC   = float(os.environ.get("MAX_PLAUSIBLE_MC",   "20000000000"))  # $20B
...
async def compute_true_x(call, dex=None, since=None):
    ...
    if entry_mc > 0 and cur_mc > 0:
        best, peak_mc = cur_mc / entry_mc, cur_mc
    elif entry_price > 0 and cur_price > 0:
        best = cur_price / entry_price
