...
# render this premium emoji as the button's icon instead. If the installed
# python-telegram-bot version is too old to know about icon_custom_emoji_id,
# or Telegram rejects it for any reason, it falls back to the original
# plain-🔮 label so buttons never break.
