...
DROPPED_X_EMOJI   = 5965474244295925497
...
def _calc_trending_kols():
    ...
    # Trending KOLs reset filter — only count calls tracked AFTER last manual reset
    cfg_now = load_config()
...
def main():
    ...
    # app.job_queue.run_repeating(trending_job,        interval=90,        first=60)    # disabled — future fix
