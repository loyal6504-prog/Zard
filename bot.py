...
# Gap between consecutive X alerts of the SAME call when a token pumps so fast
# that several milestones (2X, 3X, 4X ...) are detected in the same tick.
# First (lowest) X goes out instantly, every next X follows 5 seconds later.
MS_STAGGER_SECONDS = 5.0
