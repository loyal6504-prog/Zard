...
_dex_cache: dict = {}
_DEX_CACHE_TTL = 2   # seconds (real-time: refreshed every monitoring tick)
...
OH_PANELS = {
    "posts": ("📣 Channel Post Media",
        ...
        "🩷 <b>PinkSale Media</b>\n"
        "/addpsmedia · /listpsmedia · /removepsmedia N\n\n"
        "🧀 <b>CheesePad Media</b>\n"
        "/addcpmedia · /listcpmedia · /removecpmedia N\n"
        "ℹ️ CheesePad ab sirf apna media use karta hai (PinkSale ka nahi).\n\n"
        "📉 <b>Dropped a Call Videos</b>\n"
        "/adddroppedvideo · /listdroppedvideos · /removedroppedvideo N\n\n"
        "🩻 <b>X-Ray Videos</b>\n"
        "/addxrayvideo · /listxrayvideos · /removexrayvideo N",
    ...
    "bot": ("🤖 Bot Media & Templates",
        ...
        "/setcommandmedia COMMAND (media reply karo)\n/setcommandtext subscribe|history|linkme — text template set karo\n"
    ...
    "users": ("👥 Users, Admins & Userbot",
        ...
        "📜 Poori purani list: /ownerhelpfull · /ownerhelp2",
        []),
}
...
def _oh_main_kb():
    ...
    rows.append([InlineKeyboardButton("📚 All Owner Commands", callback_data="oh:all")])
...
OH_HOME_TEXT = (
    ...
    "Neeche se category choose karo — har button me us kaam ki saari commands hain."
)
...
async def cb_ownerhelp(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.answer()
    if data == "oh:all":
        class _OwnerHelpUpdate:
            message = query.message
            effective_user = query.from_user
        await cmd_ownerhelp_full(_OwnerHelpUpdate(), context)
        return
    if data == "oh:home":
        try:
...
def main():
    ...
    app.job_queue.run_repeating(monitoring_job,      interval=2,         first=15)   # real-time: bulk DexScreener refresh + milestone alerts
