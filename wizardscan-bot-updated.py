...
_WIZRAD_INTEL_EMOJI = {
    ...
    "profile": 5827736975250447431,   # 🔮 SIGNAL PROFILE
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.args:
        ...
        if arg.startswith("details_"):
            ...
            if not call:
                await update.message.reply_text(
                    "⚠️ Is signal ki details ab available nahi hain.")
                return
            try:
                await update.message.reply_text(
                ...
                await update.message.reply_text("⚠️ Details load nahi ho saki, dobara try karein.")
            return
